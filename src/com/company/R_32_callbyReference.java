...
public class R_32_callbyReference {
    ...
    public static void main(String[] args)
    {
      ...
      /*  R_32_callbyReference c = new R_32_callbyReference();
...
// Above three lines of code 1, 2, and 3 can be replaced by a single line of code. Both are the same as working.
        ...
        R_32_callbyReference.m2(a, ep1); // We can pass different Employee type reference variable. Reference Variable name is not important but Employee type is important. So, don't confuse in ep and ep1.

        // Or,
        R_32_callbyReference.m2(new Admin(), new Employee());*/
    }
